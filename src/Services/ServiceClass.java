...
//        System.out.println("Models.Store ID: " + store.getStoreID());
...
//            System.out.println("Models.Product: " + product.getName() + ", Quantity: " + quantity);
//        }
//    }
//
//    //sell a product
...
//                System.out.println("Models.Purchase history updated for customer " + customer.getName());
...
//            }
//        } else {
//            System.out.println("Models.Product not found in store inventory");
//        }
//    }
//
//    //add service
...
//                }
//                if (!isQualified) {
//                    System.out.println("Models.Employee is not qualified for this service");
//                    return;
//                }
//            }
//        }
...
//                    }
//                }
//                System.out.println("Models.Appointment booked for customer " + customer.getName());
//                System.out.println("Models.Appointment history: ");
//                for (Appointment appointment : customer.getAppointmentHistory()) {
//                    System.out.println("Models.Appointment ID: " + appointment.getAppointmentID());
//                    System.out.println("Models.Service ID: " + appointment.getServiceID());
//                    System.out.println("Models.Employee ID: " + appointment.getEmployeeID());
...
//                        System.out.println("Models.Appointment cancelled");
//                        return;
//                    }
//                }
//            }
//        }
//        System.out.println("Models.Appointment not found");
//    }
//
//
...
//        }
//        if (bestStore != null) {
//            System.out.println("Models.Store with the most sales: " + bestStore.getLocation() + ", Sales: " + maxSales);
//        } else {
...
//        System.out.println("Models.Purchase history: ");
//        for (Purchase purchase : customer.getPurchaseHistory()) {
//            System.out.println("Models.Purchase ID: " + purchase.getPurchaseID());
//            System.out.println("Final price: " + purchase.getFinalPrice());
//            System.out.println("Products: ");
//            for (Product product : purchase.getProducts()) {
//                System.out.println("Models.Product name: " + product.getName());
//                System.out.println("Models.Product brand: " + product.getBrand());
//                System.out.println("Models.Product price: " + product.getPrice());
//            }
//        }
...
//                    System.out.println("Models.Service name: " + service.getType());
//                    break;
//                }
//            }
//            for(Account account : Main.accounts) {
//                if (account.getAccountID() == appointment.getEmployeeID() && account instanceof Employee) {
//                    System.out.println("Models.Employee name: " + account.getName());
//                    break;
//                }
//            }
//            System.out.println("Date: " + appointment.getDate());
